...
public record Transaction(String code, PaymentEnum payment, StatusEnum status, BigDecimal value, String describe, LocalDateTime registration, CustomerBenefit customer) {
